      ...
      <div className="body-repertoire">
        <div className="left-repertoire">
          ...
          <ul>
            ...
            <li className="listen-deleted" onClick={() => play("Audios/Bach-italiano.mp3")}>
              Italian Concerto, BWV 971
              {/* <Image src="/listen.svg" alt="listen-icon" width={25} height={25} priority /> */}
            </li>
            <li>Chaconne, from the Violin Partita No. 2 in D minor (arr. Busoni)</li>
          </ul>
          <h3>Haydn</h3>
          <ul>
          ...
          <h3>Mozart</h3>
          <ul>
            <li className="listen-deleted" onClick={() => play("Audios/MozartSonata.mp3")}>
          ...
          <h3>Chopin</h3>
          <ul>
            <li className="listen-deleted" onClick={() => play("Audios/ChopinSonata2.mp3")}>
              Sonata No. 2 in Bb minor op. 35
              {/* <Image src="/listen.svg" alt="listen-icon" width={25} height={25} priority /> */}
            </li>
            <li>Sonata No. 3 in B minor op. 58</li>
            <li className="listen-deleted" onClick={() => play("Audios/Chopin-et-op10.mp3")}>
              Selection of Études op. 10
              {/* <Image src="/listen.svg" alt="listen-icon" width={25} height={25} priority /> */}
            </li>
            <li className="listen-deleted" onClick={() => play("Audios/Chopin-et-op25.mp3")}>
              Selection of Études op. 25
              {/* <Image src="/listen.svg" alt="listen-icon" width={25} height={25} priority /> */}
            </li>
            <li className="listen-deleted" onClick={() => play("Audios/ChopinWaltz.mp3")}>
              Waltzes Op. 18, 34, 64, post.
              {/* <Image src="/listen.svg" alt="listen-icon" width={25} height={25} priority /> */}
            </li>
            <li className="listen-deleted" onClick={() => play("Audios/ChopinBalladeGm.mp3")}>
            ...
            <li className="listen-deleted" onClick={() => play("Audios/Chopin-PolonBrillante.mp3")}>
              Andante Spianato & Grande Polonaise Brillante, Op. 23
              {/* <Image src="/listen.svg" alt="listen-icon" width={25} height={25} priority /> */}
            </li>
          </ul>
          <h3>Schubert</h3>
          ...
          <ul>
            ...
            <li className="listen-deleted" onClick={() => play("Audios/SchumannKreisleriana.mp3")}>
              Kreisleriana op. 16
              {/* <Image src="/listen.svg" alt="listen-icon" width={25} height={25} priority /> */}
            </li>
          ...
          <ul>
            <li
              className="listen-deleted"
              onClick={() => {
                play("Audios/AlbenizIberia.mp3");
              }}
            >
              Iberia, books 1 & 4{/* <Image src="/listen.svg" alt="listen-icon" width={25} height={25} priority /> */}
            </li>
            <li>Spanish Suite</li>
          </ul>
          <h3>Prokofiev</h3>
          <ul>
            <li className="listen-deleted" onClick={() => play("Audios/ProkofievSonata2.mp3")}>
              Sonata 2 op. 14
              {/* <Image src="/listen.svg" alt="listen-icon" width={25} height={25} priority /> */}
            </li>
          ...
          <ul>
            ...
            <li className="listen-deleted" onClick={() => play("Audios/CONCERTOBeethoven5.mp3")}>
          ...
          <h3>Tchaikovsky</h3>
          <ul>
            <li className="listen-deleted" onClick={() => play("Audios/CONCERTOTchaikovsky.mp3")}>
        ...
        <div className="right-repertoire">
          ...
          <ul>
            ...
            <li className="listen-deleted" onClick={() => play("Audios/VIOLINBrahms3.mp3")}>
          ...
          <h3>Ravel</h3>
          <ul>
            <li className="listen-deleted" onClick={() => play("Audios/VIOLINRavelSonata.mp3")}>
          ...
          <h4>Numerous violin concertos and other short virtuosic works (Wieniawski, Sarasate, Paganini, etc.)</h4>
          <h3 className="underlined afterunderlined">Cello & piano</h3>
          <h3>Beethoven</h3>
          <ul>
          ...
          <h3 className="underlined afterunderlined">Violin, Cello & Piano</h3>
          <h3>Haydn</h3>
          <ul>
