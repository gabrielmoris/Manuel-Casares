    ...
    return (
        <div className="biography">
            ...
            <div className="bio-body">
                <p>
                    Recent winner of the Special Chopin Prize at the{" "}
                    <i>Turniej Pianistów w Antoninie</i> Competition in Poland,
                    among others, Manuel Casares is a versatile musician with a
                    prolific international career and a vast repertoire as a
            ...
            <div className="bio-body">
                ...
                <p>
                    ...
                    the Academy <i>Krzysztof Penderecki</i> in Krakow, Poland,
                    where he studied under Prof. Andrzej Pikul. He has also had
                    the opportunity to learn from Prof. Ivan Klánský at the
                    Academy of Fine Arts in Prague, Czech Republic, and has
                    received masterclasses from Aquiles Delle Vigne, Peter
                    Jablonski, Nino Kereselidze, Alexander Kandelaki, among many
                    others.
                </p>
            </div>
            <div className="bio-body">
